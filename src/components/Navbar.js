        ...
        <>
            <nav className="navbar navbar-expand-lg bg-body-tertiary sticky-top">
                <div className="container-fluid">
                    <Link className="navbar-brand" to={!localStorage.getItem('token') ? "/" : "/expense"}>Expense Tracker</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link className="nav-link active" to={!localStorage.getItem('token') ? "/" : "/reports"}>Reports</Link>
                            </li>
                        </ul>
                            ...
                            <ul className="navbar-nav mb-2 mb-lg-0">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li>
                                            <Link className='dropdown-item' type="submit" to="/profile"> Profile </Link>
                                        </li>

                                        <li><hr className="dropdown-divider" /></li>
                                        <li><Link className="dropdown-item" type="submit" to="/" onClick={handledLogout}>Logout</Link></li>
                                    </ul>
                                </li>
                            </ul>  
                        </>
